...
class list extends Component{
    ...
    return(
        ...
        <h2>EMPLOYEE DETAILS</h2>
            {"  "} {load}
            <Button className="fetch" variant="success" size="sm" onClick={this.getDataHandler}>Fetch All Employees</Button> 
            <Button className="ascending" variant="success" size="sm" onClick={this.showAcending}>Ascending Order</Button>
            ...
            <label className="label1">Enter Employee Id :</label> <b/>
            <input className="input1" type="text" value={this.state.value} onChange={this.handleChange}></input>
            <Button className="button21" onClick={this.getDataSearched}>Search</Button>
